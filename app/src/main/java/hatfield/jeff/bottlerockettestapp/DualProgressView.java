...
public class DualProgressView extends View {
    ...
    protected void init(AttributeSet attrs, int defStyle) {
        ...
        mOuterCircleColor = a.getColor(R.styleable.DualProgressView_dpv_inner_color,
                ContextCompat.getColor(getContext(), R.color.color_progress_outer_ring_dark));
        mInnerCircleColor = a.getColor(R.styleable.DualProgressView_dpv_outer_color,
                ContextCompat.getColor(getContext(), R.color.color_progress_inner_ring_dark));
    ...
    public void setOuterCircleColor(int mOuterCircleColor) {
